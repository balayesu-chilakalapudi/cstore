                ...
                child: Column(
                  children: <Widget>[
                    ...
                    /*  padding: EdgeInsets.only(left: 48, right: 48),*/
                      ...
                      style:ElevatedButton.styleFrom(primary: Colors.pink,onPrimary: Colors.pink)
                     /* color: Colors.pink,
      ...
      child: Row(
        children: <Widget>[
          ...
          TextButton(
            ...
            style:TextButton.styleFrom(primary: Colors.transparent,onSurface: Colors.transparent)
